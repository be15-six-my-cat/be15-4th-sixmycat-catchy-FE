...
<template>
  <div class="main-frame">
    ...
    <div class="inputs-frame">
      <Input title="이름" text="이름을 입력해주세요" v-model="name" :readonly="nameReadonly" />
      <Input title="전화번호" text="전화번호를 입력해주세요" v-model="contactNumber" :readonly="contactReadonly" />
      <Input title="닉네임" text="영어 및 특수문자만 입력 가능합니다" v-model="nickname" />
